# Form implementation generated from reading ui file '/Users/sree/First2/CS3200/project/ui_files/add_to_watchlist.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(463, 377)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.add_uni_button = QtWidgets.QPushButton(self.centralwidget)
        self.add_uni_button.setGeometry(QtCore.QRect(160, 240, 131, 31))
        self.add_uni_button.setObjectName("add_uni_button")
        self.name_box = QtWidgets.QTextEdit(self.centralwidget)
        self.name_box.setGeometry(QtCore.QRect(80, 60, 111, 31))
        self.name_box.setObjectName("name_box")
        self.add_watchlist_label = QtWidgets.QLabel(self.centralwidget)
        self.add_watchlist_label.setGeometry(QtCore.QRect(130, 0, 191, 41))
        font = QtGui.QFont()
        ...
        self.notes_label.setGeometry(QtCore.QRect(10, 110, 61, 31))
        font = QtGui.QFont()
        font.setFamily(".AppleSystemUIFont")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.notes_box.setGeometry(QtCore.QRect(80, 110, 371, 111))
        ...
        self.shutdown_db_button.setGeometry(QtCore.QRect(310, 300, 151, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.add_uni_button.setText(_translate("MainWindow", "Add University"))
        self.add_watchlist_label.setText(_translate("MainWindow", "Add to Watchlist"))
